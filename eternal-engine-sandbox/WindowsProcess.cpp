...
Eternal::Input::Input* WindowsProcess::_InputHandler = nullptr;
...
WindowsProcess::WindowsProcess()
{
	...
	{
		_KeyMapping[KeyIndex] = Input::Key::INVALID_KEY;
	}
...
void WindowsProcess::MapRange(_In_ uint32_t WindowsKeyStart, _In_ const Eternal::Input::Input::Key& KeyNameStart, _In_ uint32_t Range)
{
	...
	{
		_KeyMapping[KeyIndex + KeyIndex] = (Input::Key)(KeyNameStart + KeyIndex);
	}
}
